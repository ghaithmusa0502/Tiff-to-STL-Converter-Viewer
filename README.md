...
### For Best Results:
- **Use High-Contrast Images**: Better height differentiation
- **Consider Scale**: Match pixels-per-unit to your intended print size
- **Test Height Settings**: Start with moderate max heights (5-20mm)
- **Preview Before Export**: Use 3D viewer to verify model appearance
